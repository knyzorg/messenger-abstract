...
(success, $) => {
  ...
  //var stopListening = api.listen((err, event) => {
    var stopListening = $.api.listen((err, event) => {
        // Using $.api.listen() is a fake and maps to $.legacyListen()
        // To get the real function you need $.api.listenReal()
        // which would break everything all other event handlers
